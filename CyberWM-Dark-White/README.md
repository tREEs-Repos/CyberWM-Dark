...
This document is from the repository "CyberWM-Dark-White" by User: "tREEs-Repos"
This document will be shown on the main page of the repository.
It is written with Markdown Formatting.

Project Directory URL:
https://github.com/tREEs-Repos/CyberWM-Dark/tree/main/CyberWM-Dark-White
--->
...
# CyberWM-Dark "White" XFCE WM Theme
...
the white theme, code named: "White".
...
CyberWM-Dark-White is ported from 'ghost-dark', a Window Manager style by [Purnomo Shinigami](https://www.xfce-look.org/u/purnomoshinigami).
...
7. Checkout the theme directory from the repo.
   ```
   git sparse-checkout set CyberWM-Dark-White/
   ```
...
10. Ship the theme config to the XFCE Themes directory.
    ...
    ```
    sudo mv -v CyberWM-Dark-White/ /usr/share/themes
    ```
    If the command is successful you will see the similar output:
    ```
    renamed 'CyberWM-Dark-White/' -> '/usr/share/themes/CyberWM-Dark-White'
    ...
    ```
    ...
    This command may require `sudo` depending on your setup / needs.
    ```
    sudo cp -rv CyberWM-Dark-White/ /usr/share/themes
    ```
    If the command is successful you will see similar output:
    ```
    'CyberWM-Dark-White/' -> '/usr/share/themes/CyberWM-Dark-White'
    ...
    ```
...
11. Your theme is now Installed successfully and ready for use.
    ...
    ```
    xfconf-query -c xfwm4 -p /general/theme -s "CyberWM-Dark-White"
    ```
...
### License
CyberWM-Dark-White is Provided under the Creative Commons Zero License. 
...
_________________________________________________________________________________________
```
A copy of the License will be cloned with this Project Directory. It is available ![here](https://github.com/tREEs-Repos/CyberWM-Dark/blob/main/CyberWM-Dark-White/LICENSE.txt).
___
