...
This document is from the repository "CyberWM-Dark-Midnight" by User: "tREEs-Repos"
This document will be shown on the main page of the repository.
It is written with Markdown Formatting.

Project Directory URL:
https://github.com/tREEs-Repos/CyberWM-Dark/tree/main/CyberWM-Dark-Midnight
--->
...
# CyberWM-Dark "Midnight" XFCE WM Theme
...
the all black theme, code named: "Midnight".
...
CyberWM-Dark-Midnight is ported from 'ghost-dark', a Window Manager style by [Purnomo Shinigami](https://www.xfce-look.org/u/purnomoshinigami).
...
7. Checkout the theme directory from the repo.
   ```
   git sparse-checkout set CyberWM-Dark-Midnight/
   ```
...
10. Ship the theme config to the XFCE Themes directory.
    ...
    ```
    sudo mv -v CyberWM-Dark-Midnight/ /usr/share/themes
    ```
    If the command is successful you will see the similar output:
    ```
    renamed 'CyberWM-Dark-Midnight/' -> '/usr/share/themes/CyberWM-Dark-Midnight'
    ...
    ```
    ...
    This command may require `sudo` depending on your setup / needs.
    ```
    sudo cp -rv CyberWM-Dark-Midnight/ /usr/share/themes
    ```
    If the command is successful you will see similar output:
    ```
    'CyberWM-Dark-Midnight/' -> '/usr/share/themes/CyberWM-Dark-Midnight'
    ...
    ```
...
11. Your theme is now Installed successfully and ready for use.
    ...
    ```
    xfconf-query -c xfwm4 -p /general/theme -s "CyberWM-Dark-Midnight"
    ```
...
### License
CyberWM-Dark-Midnight is Provided under the Creative Commons Zero License. 
