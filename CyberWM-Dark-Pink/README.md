...
This document is from the repository "CyberWM-Dark-Pink" by User: "tREEs-Repos"
This document will be shown on the main page of the repository.
It is written with Markdown Formatting.

Project Directory URL:
https://github.com/tREEs-Repos/CyberWM-Dark/tree/main/CyberWM-Dark-Pink
--->
...
# CyberWM-Dark "Pink" XFCE WM Theme
...
the light pink theme, code named: "Pink".
...
CyberWM-Dark-Pink is ported from 'ghost-dark', a Window Manager style by [Purnomo Shinigami](https://www.xfce-look.org/u/purnomoshinigami).
...
7. Checkout the theme directory from the repo.
   ```
   git sparse-checkout set CyberWM-Dark-Pink/
   ```
...
10. Ship the theme config to the XFCE Themes directory.
    ...
    ```
    sudo mv -v CyberWM-Dark-Pink/ /usr/share/themes
    ```
    If the command is successful you will see the similar output:
    ```
    renamed 'CyberWM-Dark-Pink/' -> '/usr/share/themes/CyberWM-Dark-Pink'
    ...
    ```
    ...
    This command may require `sudo` depending on your setup / needs.
    ```
    sudo cp -rv CyberWM-Dark-Pink/ /usr/share/themes
    ```
    If the command is successful you will see similar output:
    ```
    'CyberWM-Dark-Pink/' -> '/usr/share/themes/CyberWM-Dark-Pink'
    ...
    ```
...
11. Your theme is now Installed successfully and ready for use.
    ...
    ```
    xfconf-query -c xfwm4 -p /general/theme -s "CyberWM-Dark-Pink"
    ```
...
### License
CyberWM-Dark-Pink is Provided under the Creative Commons Zero License. 
...
_________________________________________________________________________________________
```
A copy of the License will be cloned with this Project Directory. It is available ![here](https://github.com/tREEs-Repos/CyberWM-Dark/blob/main/CyberWM-Dark-Pink/LICENSE.txt).
___
