...
This document is from the repository "CyberWM-Dark-LightBlue" by User: "tREEs-Repos"
This document will be shown on the main page of the repository.
It is written with Markdown Formatting.

Project Directory URL:
https://github.com/tREEs-Repos/CyberWM-Dark/tree/main/CyberWM-Dark-LightBlue
--->
...
# CyberWM-Dark "Light Blue" XFCE WM Theme
...
the light blue theme, code named: "LightBlue".
...
CyberWM-Dark-LightBlue is ported from 'ghost-dark', a Window Manager style by [Purnomo Shinigami](https://www.xfce-look.org/u/purnomoshinigami).
...
7. Checkout the theme directory from the repo.
   ```
   git sparse-checkout set CyberWM-Dark-LightBlue/
   ```
...
10. Ship the theme config to the XFCE Themes directory.
    ...
    ```
    sudo mv -v CyberWM-Dark-LightBlue/ /usr/share/themes
    ```
    If the command is successful you will see the similar output:
    ```
    renamed 'CyberWM-Dark-LightBlue/' -> '/usr/share/themes/CyberWM-Dark-LightBlue'
    ...
    ```
    ...
    This command may require `sudo` depending on your setup / needs.
    ```
    sudo cp -rv CyberWM-Dark-LightBlue/ /usr/share/themes
    ```
    If the command is successful you will see similar output:
    ```
    'CyberWM-Dark-LightBlue/' -> '/usr/share/themes/CyberWM-Dark-LightBlue'
    ...
    ```
...
11. Your theme is now Installed successfully and ready for use.
    ...
    ```
    xfconf-query -c xfwm4 -p /general/theme -s "CyberWM-Dark-LightBlue"
    ```
...
### License
CyberWM-Dark-LightBlue is Provided under the Creative Commons Zero License. 
